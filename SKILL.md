...
5. **Revisar referencias visuales previas** (opcional pero recomendado): activar el plugin **Microsoft 365** y seguir `sub-skill/leer-imagenes-onedrive/README.md` (preguntar al usuario si desea leer la carpeta para conocer los nombres de campañas pasadas, máx. 10 archivos, y ofrecerle la opción de adjuntar 1 a 3 imágenes de ejemplo en el chat para visión estética) → inspiración + evitar repetir diseños.
